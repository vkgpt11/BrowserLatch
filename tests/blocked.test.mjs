...
function page(query = '', rules = []) {
  ...
  dom.window.chrome = {storage: {session: {set: async value => pending.push(value)}}, declarativeNetRequest: {getDynamicRules: async () => {if (rules instanceof Error) throw rules; return rules;}}, runtime: {openOptionsPage: async () => {opened++;}}};
